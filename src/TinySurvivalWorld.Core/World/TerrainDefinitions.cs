...
public static class TerrainDefinitions
{
    private static readonly Dictionary<TileType, TerrainProperties> _definitions = new()
    {
        ...
        // Eau peu profonde - Zone côtière, quelques créatures aquatiques - TERRAIN DIFFICILE
        ...
        // Marécage - Zone dangereuse, riche en vie hostile - TERRAIN DIFFICILE
        ...
        // Zone toxique - Très dangereux, mobs mutants, ressources contaminées - TOXIQUE

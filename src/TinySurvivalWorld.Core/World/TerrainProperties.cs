...
public class TerrainProperties
{
    ...
    public TerrainProperties(float mobSpawnProbability, float resourceSpawnProbability, float itemSpawnProbability)
    {
    ...
    /// </summary>
    public static TerrainProperties Default => new(0.0f, 0.0f, 0.0f);
}
